...
interface AskMoviePanelProps {
  isOpen: boolean;
  onClose: () => void;
}

const AskMoviePanel: React.FC<AskMoviePanelProps> = ({ isOpen, onClose }) => {
  ...
  return (
    <>
      ...
      {/* Modal Window Container - Identical size to 家宽导航, Loaded On-Demand */}
      <motion.div 
